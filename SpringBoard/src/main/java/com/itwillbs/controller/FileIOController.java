...
public class FileIOController {
	...
	public void fileDownloadGET(@RequestParam("fileName") String fileName, HttpServletResponse response)
			throws Exception {
...
//		response.addHeader("Content-dispostion", "attachment; fileName=" + fileName);
		response.addHeader("Content-dispostion", "attachment; fileName=" + URLEncoder.encode(fileName, "UTF-8"));
